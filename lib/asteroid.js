(function () {
  ...
  var Asteroid = window.Asteroids.Asteroid = function (pos, game) {
    ...
    window.Asteroids.MovingObject.call(this, pos, vel, game.randomSize(Asteroid.RADIUS), Asteroid.COLOR, game);
  };
  ...
  Asteroid.prototype.collideWith = function (otherObject){
    if (otherObject instanceof window.Asteroids.Ship){
      ...
      //   var aster = new Asteroid(this.game.randomTopPosition(), this.game);
