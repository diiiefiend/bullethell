  ...
  Enemy1.prototype.getAttackPattern = function (){
    if(this.pos[1] >= (window.BHGame.Game.DIM_Y/8 - 1) &&
      ...
      if(!this.bulletIntervalIds[0]){
        this.bulletIntervalIds[0] = window.setInterval(this.fireBullet.bind(this, 180), 750);
      };
      ...
      window.setTimeout( function (){
        ...
        if(!this.bulletIntervalIds[1]){
          this.bulletIntervalIds[1] = window.setInterval(this.fireBullet.bind(this, 180), 600);
        };
        this.vel[1] = 1;
      }.bind(this), 5000);
    };
