...
(function (){
  ...
  var GameView = window.BHGame.GameView = function(game, bgctxt, fgctxt, tempCanvas){
    this.game = game;
    this.bgctxt = bgctxt;
    this.fgctxt = fgctxt;
  ...
  GameView.prototype.addKeyBindings = function (){
    this.$el.keydown(function (e){
      var code = e.keyCode;
      if(code >= 37 && code <= 40) {e.preventDefault(); };
  ...
  GameView.prototype.displayGameOver = function (){
    ...
    this.fgctxt.font = "300 36px helvetica neue, arial";
    this.fgctxt.fillStyle = "red";
    this.fgctxt.textAlign = "center";
    ...
    this.fgctxt.fillText(text, BHGame.Game.DIM_X/2, BHGame.Game.DIM_Y/2);

    this.fgctxt.font = "300 20px helvetica neue, arial";
    this.fgctxt.fillStyle = "gray";
    this.fgctxt.textAlign = "center";
    this.fgctxt.fillText("press z to play again", BHGame.Game.DIM_X/2, BHGame.Game.DIM_Y/2+ 40);
