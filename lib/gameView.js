(function (){
  ...
  GameView.prototype.displayGameOver = function (){
    ...
    this.ctxt.fillText(text, Asteroids.Game.DIM_X/2, Asteroids.Game.DIM_Y/2);

    this.ctxt.font = "20px sans-serif";
    this.ctxt.fillStyle = "gray";
    this.ctxt.textAlign = "center";
    this.ctxt.fillText("press z to play again", Asteroids.Game.DIM_X/2, Asteroids.Game.DIM_Y/2+ 40);
