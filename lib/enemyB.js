(function () {
  ...
  var EnemyB = window.BHGame.EnemyB = function (game) {
    ...
    //source : http://artscum.files.wordpress.com/2010/11/onslaught_sprite.jpg
    this.enemySprite.src = "img/boss.png";
  };
  ...
  EnemyB.prototype.getAttackPattern = function (){
    ...
    if(this.health < EnemyB.HEALTH/2 && !this.attackIntervalIds[2]){
  ...
  EnemyB.prototype.draw = function (){
    ...
    ctxt.drawImage(this.enemySprite, 0, 0, 200, 264, -100, -132, 200, 264);
