(function () {
  ...
  Game.prototype.draw = function (ctxt) {
    ...
    ctxt.fillText("Orientation: "+this.ship.direction, 30, 30);
    ctxt.fillText("Lateral drift: "+ Math.round(this.ship.vel[0]), 30, 50);
    ctxt.fillText("Thrust: "+ Math.round(this.ship.vel[1]), 30, 70);
