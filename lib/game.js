(function () {
  ...
  Game.prototype.populateBHGame = function () {
    ...
    var WAVE_NUM = 0;
    var firstWaveId = window.setTimeout( function (){
      for(var j = 0; j < Game.WAVES[WAVE_NUM]; j++){
        var enemy = new BHGame.Enemy1([Game.WAVE_POSITIONS[WAVE_NUM][j], 1], this);
  ...
  Game.prototype.step = function () {
    ...
    if(this.score > 10 && !this.bossStage){
     this.bossStage = true;
     this.add(new window.BHGame.EnemyB(this));
    };
  };
  ...
  Game.prototype.remove = function (object) {
    if (object instanceof window.BHGame.EnemyObject){
      object.clearBulletIntervals();
      this.enemies.splice(this.enemies.indexOf(object), 1);
      if (object instanceof window.BHGame.EnemyB){
