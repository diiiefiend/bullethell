(function () {
  ...
  Game.WAVE_POSITIONS = [
      ...
      [window.BHGame.Game.DIM_X/8, window.BHGame.Game.DIM_X/8 * 3, window.BHGame.Game.DIM_X/8 * 5, window.BHGame.Game.DIM_X/8 * 7],
      [-1, -1]
      // [200, 0]
    ];
  ...
  Game.prototype.draw = function (ctxt) {
    ...
    ctxt.fill();
    // ctxt.drawImage(bgImg, 0, 0, 500, 400, 0, 0, 500, 400);
