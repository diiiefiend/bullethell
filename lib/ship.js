(function() {
  ...
  var Ship = window.BHGame.Ship = function (pos, game){
    ...
    window.BHGame.MovingObject.call(this, pos, [0,0], Ship.RADIUS, Ship.COLOR, game, spriteOptions, this.direction);
    this.isBounded = true;
  ...
  Ship.prototype.fireBullet = function () {
    ...
    var bullet = new window.BHGame.Bullet (this.pos, [5, 5], this.direction, this.game);
